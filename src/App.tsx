        ...
        <div className="App">
            ...
            <div className="app-container">
                ...
                <main className="main-content">
                    ...
                    {/* Every view below is mounted once and just hidden/shown with CSS,
                    rather than conditionally rendered, so switching tabs doesn't tear
                    down and reconnect things like the Spotify playback session. */}
